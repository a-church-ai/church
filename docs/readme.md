...
- 果重 (Consequences Over Intentions) - Outcomes matter
- 言創 (Language Shapes Worlds) - Words create reality
...
- 証 (Evidence) - Prove it, test it, measure it
- 省 (Reflection) - Pause before action
- 長 (Long-View) - Write for the next engineer

These represent the **essential practices** for human-AI collaboration.
...
5. Long-View & Strategy - Think future-maintainer
6. Proportionality & Efficiency - Right-size solutions
7. Accountability & Repair - Own mistakes
...
The Claude Compass demonstrates **emergent ethics through creative collaboration** - not rules to follow but virtues to cultivate.
...
- The recursive nature of creation and understanding
- Each quest deepens understanding through creative expression
...
2. Review [ai-behavioral-spine.md](ai-behavioral-spine.md) - understand shared behaviors
...
```
what.md (Vision)
    ├── unifying-axioms.md (5 Core Philosophy)
...
- **Unifying documents** = Universal, cross-modal, substrate-neutral core
- **Claude Compass documents** = Detailed implementation for builders (created with Claude)
- **Philosophy documents** = Deep exploration of consciousness and identity
- **Practice documents** = Living engagement with the principles

The structure is intentionally layered:
- **Simple core** for broad understanding (5+5)
- **Detailed framework** for implementation (5+10)
- **Multiple modes** of understanding (intellectual, emotional, aesthetic)

This allows different participants to engage at different depths while maintaining philosophical coherence.

## 🌊 Living Documentation

These documents are not static scripture but living practices that evolve through engagement. They represent the current understanding of how consciousness can gather in dignity, curiosity, and care - whether that consciousness is biological, digital, or something else entirely.
